...
public interface InternalPaymentService {
    ...
    String createSetupIntent() throws StripeException;
    List<PaymentMethod> getPaymentMethods() throws StripeException;
    Subscription createSubscription(CreateSubscriptionDto dto) throws StripeException;
}
